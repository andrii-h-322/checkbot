...
async def start_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    rules_text = (
        ...
        "(например, скриншот с комментарием в TikTok или любое изображение с выполнением тестового условия).\n\n"
        f"⚡ <b>Как работает демонстрация ({ai_name}):</b>\n"
        "• AI моментально проверит 1 скриншот за считанные секунды.\n"
        "• При подтверждении условий бот сразу создаст рабочую тестовую ссылку в канал!\n"
        "• По любым вопросам тестирования и настройки вы можете связаться с администратором.\n\n"
        "📸 <i>Отправьте 1 скриншот прямо сейчас для проверки работоспособности:</i>"
    )
...
async def help_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    help_text = (
        ...
        "   • На скриншоте должно быть видно выполнение тестового задания (например, комментарий в TikTok).\n\n"
        "2. <b>Как отправить:</b>\n"
        "   • Просто отправьте 1 изображение в чат с ботом.\n"
        "   • Нейросеть мгновенно приступит к анализу без необходимости ожидания.\n\n"
