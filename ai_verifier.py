...
class AIVerifier:
        ...
        messages = [
            {
                "role": "system",
                "content": (
                    "Ты профессиональный верификатор выполнения условий в демонстрационном боте для проверки работоспособности AI. "
    ...
    async def _verify_with_gemini(
        ...
        prompt = (
            ...
            f"Тебе предоставлено {len(images_bytes)} скриншот(ов).\n"
            f"Критерии проверки:\n{criteria}\n\n"
            "Внимательно изучи предоставленный скриншот:\n"
            "• Если все условия выполнены — установи approved=true и подтверди выполнение.\n"
            "• Если чего-то не хватает, скриншот обрезан, условия не выполнены или изображение не относится к делу — "
